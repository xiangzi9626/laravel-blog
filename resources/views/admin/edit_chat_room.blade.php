...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" lay-reqtext="聊天室名称不能为空" placeholder="请输入" value="{{$res["name"]}}" class="layui-input">
         </div>
    </div>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
           ...
           var domain = window.location.protocol+"//"+document.domain;
            domain=domain+"/admin/edit_chat_room/{{$_GET["id"]}}?_token={{csrf_token()}}";
          $.ajax({
              type:'POST',
              url:domain,
              data:str,
