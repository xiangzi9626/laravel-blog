...
<head>
    ...
    <link rel="stylesheet" href="/layuimini-2/css/layuimini.css?v=2.0.1" media="all">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                       <!-- <dd>
                        ...
                        <dd>
                            <a onclick="modify_password()" href="javascript:void(0)" layuimini-content-href="/layuimini-2/admin/modify_admin_password.html" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        var options = {
            ...
            clearUrl: "/admin/clear_cache", // 缓存清理接口
